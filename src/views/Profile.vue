<template>
  <div class="space-y-8">
    ...
    <!-- {/* --- ОБНОВЛЕННАЯ СЕКЦИЯ: My Tournaments --- */} -->
     <div class="space-y-4">
        <h3 class="text-2xl font-semibold text-[var(--color-text-light)]">My Tournaments</h3>
        ...
        <div v-else-if="myOrganizedTournaments.length === 0" class="text-center text-[var(--color-text-muted)]">You haven't organized any tournaments yet.</div>
