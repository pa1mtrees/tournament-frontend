          ...
          <div class="flex-shrink-0 md:w-48 lg:w-64">
            <div class="rounded-lg flex items-center justify-center overflow-visible">
              <img 
                ...
                class="w-full h-full object-contain m-2 rounded-3xl"
              >
          ...
          <div v-if="activeTab === 'participants'">
              ...
              <ul v-else class="space-y-3">
                  <li v-for="p in participants" :key="p.id" 
                      class="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 p-3 bg-[var(--color-secondary)] rounded-lg shadow hover:shadow-md transition-shadow">
                      <div class="flex items-center space-x-4 flex-grow w-full sm:w-auto">
                          ...
                          <div class="flex-grow min-w-0">
                              <router-link 
                                  ...
                                  class="block text-md font-semibold text-[var(--color-text-light)] hover:text-[var(--color-myred)] truncate"
                      ...
                      <div class="flex items-center space-x-2 ml-auto flex-shrink-0 w-full sm:w-auto justify-end">
                          <el-tag 
                              ...
                              class="flex-shrink-0"
                          >
                              <span class="text-secondary text-sm font-semibold">{{ getDisplayParticipantStatus(p.status) }}</span>
                          </el-tag>
            ...
            <div v-else-if="bracketData && bracketData.rounds && bracketData.rounds.length > 0">
              <!-- Round Titles -->
              <div 
